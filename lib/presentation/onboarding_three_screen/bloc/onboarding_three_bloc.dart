...
import 'package:amit_s_application2/presentation/onboarding_three_screen/models/onboarding_three_model.dart';
...
class OnboardingThreeBloc
  ...
  List<EightItemModel> fillEightItemList() {
    return List.generate(2, (index) => EightItemModel());
  }
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        onboardingThreeModelObj: state.onboardingThreeModelObj
            ?.copyWith(eightItemList: fillEightItemList())));
  }
}
